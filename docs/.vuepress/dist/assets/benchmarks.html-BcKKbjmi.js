import{_ as e,c as l,a,b as i,d as r,o as t,r as p}from"./app-qCzLT1HQ.js";const c={};function d(o,s){const n=p("BenchmarkChart");return t(),l("div",null,[s[0]||(s[0]=a("h1",{id:"benchmarks",tabindex:"-1"},[a("a",{class:"header-anchor",href:"#benchmarks"},[a("span",null,"Benchmarks")])],-1)),s[1]||(s[1]=a("h2",{id:"benchmark-result",tabindex:"-1"},[a("a",{class:"header-anchor",href:"#benchmark-result"},[a("span",null,"Benchmark Result")])],-1)),s[2]||(s[2]=a("p",null,"Here is the benchmark result of TPC-DS 1TB Dataset, running under Spark-3.5 and Blaze-4.0.1-preview.",-1)),i(n),s[3]||(s[3]=r(`<p>Below is a brief introduction of how we run TPC-DS benchmark with Spark/Blaze.</p><h2 id="generate-tpc-ds-dataset" tabindex="-1"><a class="header-anchor" href="#generate-tpc-ds-dataset"><span>Generate TPC-DS dataset</span></a></h2><p>Compile datagen tool (derived from <a href="https://github.com/maropu/spark-tpcds-datagen%5D" target="_blank" rel="noopener noreferrer">maropu/spark-tpcds-datagen</a>).</p><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token builtin class-name">cd</span> tpcds/datagen</span>
...
<span class="line">mvn package <span class="token parameter variable">-DskipTests</span></span>
<span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div></div></div><p>Edit your <code>$SPARK_HOME/conf/spark-default.conf</code> to enable/disable Blaze (see the following conf), then launch benchmark runner. If benchmarking with Blaze, ensure that the Blaze jar package is correctly built and moved into <code>$SPARK_HOME/jars</code>. (<a href="https://github.com/kwai/blaze/#build-from-source" target="_blank" rel="noopener noreferrer">How to build Blaze?</a>)</p><div class="language-bash line-numbers-mode" data-highlighter="prismjs" data-ext="sh" data-title="sh"><pre><code><span class="line"><span class="token comment"># use correct SPARK_HOME and data location</span></span>
