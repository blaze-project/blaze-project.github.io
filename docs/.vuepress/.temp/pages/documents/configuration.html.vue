<template><div><h1 id="configurations-for-blaze" tabindex="-1"><a class="header-anchor" href="#configurations-for-blaze"><span>Configurations for Blaze</span></a></h1>
<h2 id="blaze-runtime-parameter" tabindex="-1"><a class="header-anchor" href="#blaze-runtime-parameter"><span>Blaze Runtime Parameter</span></a></h2>
